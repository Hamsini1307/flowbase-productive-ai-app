      ...
      <div className="flex min-h-screen">
                ...
                {group.items.map((item) => (
                  <button
                    ...
                    className={cn(
                      ...
                      item.active && "bg-[#17201e] text-[#f7fff9] shadow-sm hover:bg-[#17201e] hover:text-[#f7fff9]",
        ...
        <main className="min-w-0 flex-1 overflow-hidden">
          <header className="flex min-h-16 items-center justify-between border-b border-[#d6e7df] bg-[#f8fff9]/85 px-5 backdrop-blur">
            <div>
              <p className="text-xs font-medium text-[#66756f]">Dashboard</p>
              <h1 className="text-xl font-semibold text-[#17201e]">Good afternoon, Hamsini</h1>
            </div>
